...
a <- plotCrudeRatesPerYearBothGender(testFullRangeData, 60, moreDataSets = testClassicModelFullRange)
b <- plotCrudeRatesPerYearBothGender(testFullRangeData, 70, moreDataSets = testClassicModelFullRange)
c <- plotCrudeRatesPerYearBothGender(testFullRangeData, 80, moreDataSets = testClassicModelFullRange)
d <- plotCrudeRatesPerYearBothGender(testFullRangeData, 90, moreDataSets = testClassicModelFullRange)
combined <- a + b + c + d & theme(legend.position = "bottom")
combined + plot_layout(guides = "collect") + plot_annotation(title = "Test")


a <- plotCrudeRatesPerAgeBothGender(testFullRangeData, 2001, moreDataSets = testClassicModelFullRange)
b <- plotCrudeRatesPerAgeBothGender(testFullRangeData, 2006, moreDataSets = testClassicModelFullRange)
c <- plotCrudeRatesPerAgeBothGender(testFullRangeData, 2011, moreDataSets = testClassicModelFullRange)
d <- plotCrudeRatesPerAgeBothGender(testFullRangeData, 2016, moreDataSets = testClassicModelFullRange)
combined <- a + b + c + d & theme(legend.position = "bottom")
combined + plot_layout(guides = "collect") + plot_annotation(title = "Test")
